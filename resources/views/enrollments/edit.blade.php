                ...
                <div class="col-md-6">
                    ...
                    <select name="branch_id" id="branchSelect" class="form-control @error('branch_id') is-invalid @enderror" onchange="loadTherapists(this.value)">
                        ...
                        @foreach($branches as $branch)
                            <option value="{{ $branch->id }}" {{ (int) old('branch_id', $enrollment->branch_id) === $branch->id ? 'selected' : '' }}>{{ $branch->name }}</option>
                        @endforeach
                    </select>
                ...
                <div id="durationSection" style="display:none;" class="col-12">
                    <div class="row g-3">
                        <div class="col-6">
                            ...
                            <input type="number" name="duration_value" id="durationValue" value="{{ old('duration_value', $enrollment->duration_value) }}" class="form-control" min="1" placeholder="e.g. 3" oninput="recalculate()">
                        </div>
                        <div class="col-6">
