                            ...
                            <td>
                                <div style="display:flex;gap:6px;">
                                    ...
                                    <form action="{{ route('therapists.destroy', $t->id) }}" method="POST">
                                        @csrf @method('DELETE')
                                        <button type="submit" style="background:none;border:1.5px solid var(--danger);color:var(--danger);border-radius:var(--radius-btn);padding:4px 10px;cursor:pointer;font-size:12px;" data-confirm="Permanently delete this therapist? This cannot be undone."><i class="fa-solid fa-trash"></i></button>
                                    </form>
                                </div>
                            </td>
                        </tr>
