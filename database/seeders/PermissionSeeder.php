...
class PermissionSeeder extends Seeder
{
    public function run(): void
    {
        $permissions = [
            ...
            ['name' => 'register_children',       'display_name' => 'Register Child',         'module' => 'children'],
            ['name' => 'view_children',           'display_name' => 'View Children',          'module' => 'children'],
            ['name' => 'approve_children',        'display_name' => 'Approve Children',       'module' => 'children'],
            ['name' => 'manage_disabilities',     'display_name' => 'Manage Present Complaints',    'module' => 'present_complaints'],
            ...
            ['name' => 'view_enrollments',        'display_name' => 'View Enrollments',       'module' => 'enrollments'],
            ['name' => 'approve_high_discount',   'display_name' => 'Approve High Discount',  'module' => 'enrollments'],
            ['name' => 'view_staff_users',        'display_name' => 'View Staff Users',       'module' => 'users'],
